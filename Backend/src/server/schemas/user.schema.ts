...
export const userModel = z.object({
	...
	email: z.string().min(3, "Minimum length for email should be 3").describe("Email of user"),
	address: z.string().min(10, "Minimum length for address should be 10").describe("Address of the user"),
	city: z.string().min(3, "Minimum length for city should be 3").describe("City of the user"),
