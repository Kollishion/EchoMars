...
const getParameterObjects = (schema, required, pathParameters, headersSchema, inType) => {
    ...
    res = Object.assign(Object.assign({}, res), { path: v4_1.z.object(path), query: v4_1.z.object(query) });
    return res;
};
...
const getRequestBodyObject = (schema, required, pathParameters, contentTypes) => {
    ...
    try {
        ...
        dedupedSchema = v4_1.z.object(filteredShape);
    }
            ...
            content: {
                'application/json': {
                    schema: v4_1.z
                        ...
                        code: v4_1.z.string().meta({
                            description: 'The error code',
                            example: code !== null && code !== void 0 ? code : 'INTERNAL_SERVER_ERROR',
                        }),
                        issues: v4_1.z
                            .array(v4_1.z.object({ message: v4_1.z.string() }))
                            .optional()
                            .meta({
