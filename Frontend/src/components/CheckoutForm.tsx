			...
			<form onSubmit={handleSubmit} className="grid md:grid-cols-2 gap-6">
				<div>
					...
					<input
						...
						className={`w-full bg-gray-900 border ${errors.firstName ? "border-red-500" : "border-gray-700"
				...
				<div>
					...
					<input
						...
						className={`w-full bg-gray-900 border ${errors.lastName ? "border-red-500" : "border-gray-700"
							} text-gray-100 px-4 py-2.5 rounded-lg focus:outline-none focus:border-blue-500`}
				...
				<div>
					...
					<input
						...
						inputMode="numeric"
						className={`no-spinner w-full bg-gray-900 border ${errors.phone ? "border-red-500" : "border-gray-700"
							} text-gray-100 px-4 py-2.5 rounded-lg focus:outline-none focus:border-blue-500`}
				...
				<div className="md:col-span-2">
					...
					<input
						...
						className={`w-full bg-gray-900 border ${errors.address ? "border-red-500" : "border-gray-700"
							} text-gray-100 px-4 py-2.5 rounded-lg focus:outline-none focus:border-blue-500`}
				...
				<div>
					...
					<input
						...
						className={`w-full bg-gray-900 border ${errors.city ? "border-red-500" : "border-gray-700"
							} text-gray-100 px-4 py-2.5 rounded-lg focus:outline-none focus:border-blue-500`}
				...
				<div>
					...
					<input
						...
						className={`w-full bg-gray-900 border ${errors.state ? "border-red-500" : "border-gray-700"
							} text-gray-100 px-4 py-2.5 rounded-lg focus:outline-none focus:border-blue-500`}
				...
				<div>
					...
					<input
						...
						inputMode="numeric"
						className={`no-spinner w-full bg-gray-900 border ${errors.zip ? "border-red-500" : "border-gray-700"
							} text-gray-100 px-4 py-2.5 rounded-lg focus:outline-none focus:border-blue-500`}
				...
				<div>
					...
					<input
						...
						className={`w-full bg-gray-900 border ${errors.landmark ? "border-red-500" : "border-gray-700"
							} text-gray-100 px-4 py-2.5 rounded-lg focus:outline-none focus:border-blue-500`}
